 ...
 *
 */
	class DesignersImageBlockController extends BlockController {
		...
		public function getBlockTypeDescription() {
			return t("Adds designers images from the library to pages.");
		}
		
		public function getBlockTypeName() {
			return t("Designers Image");
		}		
		...
		function getContentAndGenerate($align = false, $style = false, $id = null) {
			...
			$pre_img = "<div class=\"item count3 {$tag}\">";
			...
			$img = "<img border=\"0\" class=\"ccm-image-block\" alt=\"{$title}\" src=\"{$relPath}\" {$sizeStr} ";
			...
			$post_img = "<div class=\"pwhite\">
                        
                            <div class=\"pinfo\">
                            
                                <a class=\"fancyboxnumber\" href=\"{$relPath}\" title=\"{$title}\">
                                    <img src=\"/packages/sash_theme/themes/sash_theme/images/pi.png\" alt=\"More\"></a>
